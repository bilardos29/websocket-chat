...
import 'package:websocketchat/feature_room/context/context.dart';
...
final getAllRoomStateProvider = StateNotifierProvider.autoDispose
    .family<GetAllRoomStateProvider, Resource<List<RoomModel>>, String>((ref, noval) {
  ref.onDispose(
        () => logger.shout(
        "Get all room provider has been disposed"),
  );

  return GetAllRoomStateProvider(ref.read(_roomprovider))..getAllRoom();
});
